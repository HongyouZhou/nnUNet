...
def nrrd2blosc2(load_filepath, save_filepath):
    image = MedVol(load_filepath)
    blosc2.asarray(array=image.array, urlpath=save_filepath, meta={"spacing": image.spacing, "origin": image.origin, "direction": image.direction, "header": image.header})


if __name__ == '__main__':
    load_filepath = "/path/to/image.nrrd"
    save_filepath = "/path/to/image.blosc2"

    nrrd2blosc2(load_filepath, save_filepath)